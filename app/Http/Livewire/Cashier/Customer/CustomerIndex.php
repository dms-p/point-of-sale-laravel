...
namespace App\Http\Livewire\Cashier\Customer;
...
class CustomerIndex extends Component
{
    ...
    {
        return view('livewire.cashier.customer.customer-index',['customers'=>customer::where('name','like','%'.$this->search."%")->orderBy('created_at','DESC')->paginate($this->listCount)]);
    }
}

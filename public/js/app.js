...
var swalAlert = function swalAlert(icon, title, text) {
...
var swalConfirm = function swalConfirm(title, method, param) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire({
    'icon': 'question',
    "title": title,
...
document.addEventListener('livewire:load', function () {
  Livewire.on('swalAlert', function (data) {
    swalAlert(data.icon, data.title, data.text);
  });
  Livewire.on('swalConfirm', function (data) {
    swalConfirm(data.title, data.method, data.param);
  });
  Livewire.on('console', function (data) {
    console.log(data);
  });
...
__webpack_require__(/*! E:\xampp\htdocs\gentaPoslite\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\xampp\htdocs\gentaPoslite\resources\css\app.css */"./resources/css/app.css");

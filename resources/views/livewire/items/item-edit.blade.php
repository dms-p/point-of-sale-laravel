<div>
    ...
    <header class="flex items-center justify-between mb-4">
        <h1 class="font-semibold text-xl text-gray-800">Update Item</h1>
    </header>
    <main>
                        ...
                        <div class="sm:w-4/6 w-full flex flex-wrap">
                            ...
                            <div class="sm:w-1/2 w-full px-2 mb-3">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <label class="mr-3 font-semibold cursor-pointer text-sm text-gray-700"><input class="mr-1 " type="radio" value="yes" name="discontinue" wire:model.defer="item.discontinue">Yes</label>
                                    <label class="font-semibold cursor-pointer text-sm text-gray-700"><input class="mr-1 " checked type="radio" value="no" name="discontinue" wire:model.defer="item.discontinue">No</label>

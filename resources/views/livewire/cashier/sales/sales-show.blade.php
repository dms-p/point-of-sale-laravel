<div>
    ...
    <header class="flex items-center justify-between mb-4">
        ...
        <div class="inline-flex justify-center">
            <button class="mr-2 btn btn-indigo" wire:loading.attr="disabled" wire:target="print" wire:click="print('{{$transaction->slug}}')">
            ...
            <button class="btn btn-red" type="button" wire:loading.attr="disabled" wire:target='donwload' wire:click="download" >

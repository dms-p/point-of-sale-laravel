<div>
    ...
    <header class="flex items-center justify-between mb-4">
        <h1 class="font-semibold text-xl text-gray-800">Categories</h1>
    </header>
    <main class="flex flex-col sm:flex-row">
        <div class="sm:w-2/6  w-full p-1">
            <div class="pt-6 pb-2 px-3 bg-white rounded-md shadow overflow-hidden sm:rounded-md w-full">
                @if ($status=='edit')
                    @livewire('categories.category-edit')
                @else
                                ...
                                <tr class="bg-white font-normal hover:bg-gray-50 antialiased border-b border-gray-200">
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex justify-center">
                                            <button type="button" wire:click="edit({{$category->id}})" class="btn-sm mr-2 btn-secondary">
                                            ...
                                            <button type="button" wire:click="$emit('confirmDelete',{{$category->id}})" class="btn-sm btn-secondary">
